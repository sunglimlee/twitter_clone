...
class AuthAPI implements IAuthAPI {
  ...
  // 현재 User 의 Account 를 받아오는 부분
  @override
  Future<model.Account?> currentUserAccount() async {
    print("currentUserAccoount() 부분");
    _account == null ? print("null") : print("not null");
/*
    try {
*/
    final result = await _account.get(); // 너무 간단하다. 그냥 _account.get() 하면 된다.
//      print("Auth_api.dart 부분 ${result.email} 의 값은 나왔나?");
    return result;
/*
